...
<div class="panel">
    <div class="col-sm-12">
        <a href='index.php?t' title='Insert' style='margin-right:5px' class='btn btn-primary btn-sm'>Tambah</a>
            ...
            <table class="table table-bordered">
                ...
                <?php while ($row = $this->model->fetch($data)) { ?>
                    <tr>
                        ...
                        <td>
                            <div class=''>
                                <a href='index.php?u=$row[id_jadwal]' title='Update' style='margin-right:5px' class='btn btn-success btn-sm'>
